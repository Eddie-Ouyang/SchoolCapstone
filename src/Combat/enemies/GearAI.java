...
public class GearAI extends EnemyAI {
	/**
	 * Creates a controller for a GearEnemy 
	 * @param E GearEnemy that the controller is bound to
	 */
	public GearAI (GearEnemy E) {
		super.entity = E;
	}
